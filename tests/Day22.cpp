...
char const* input = R"MULTILINE(on x=-5..47,y=-31..22,z=-19..33
...
off x=-93533..-4276,y=-16170..68771,z=-104985..-24507)MULTILINE";

auto const expected_part1 = 474140lu;
auto const expected_part2 = 2758514936282235lu;
using Day = AdventDay<id, parsed, result1, result2>;

}

SCENARIO("2021.day.22","[2021][22]") {
    GIVEN("Sample input") {
