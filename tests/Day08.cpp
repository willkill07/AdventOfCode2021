...
char const* input = R"MULTILINE(be cfbegad cbdgef fgaecd cgeb fdcge agebfd fecdb fabcd edb |
...
fgae cfgab fg bagce)MULTILINE";

auto const expected_part1 = 26;
auto const expected_part2 = 61229;
using Day = AdventDay<id, parsed, result1, result2>;

}

SCENARIO("2021.day.08","[2021][08]") {
    GIVEN("Sample input") {
